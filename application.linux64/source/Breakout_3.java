...
public class Breakout_3 extends PApplet {
...
public void drawWall() {
  ...
  text(" " +round( counter/5.8f * 100.0f ) / 100.0f+" % completed ", width/2-310, 25);
...
public int selectRectColor(int b, int colorOption) {
...
public void CheckPwrUpCollision(float xPowerUp, float yPowerUp) {
...
class Ball
{
 ...
 // img = loadImage("ball.png");
  ...
  public void CheckCollisionWithBricks( Rectangle r) 
  {
    ...
    if (((x>=r.x+15)&&(x<=r.x+55))&&(y<=r.y+5)&&(y>=r.y)) {
      ...
      Breakout_3.points++;
      Breakout_3.tailSize =  Breakout_3.tailSize-0.14f;
      reSize();
...
public void changeSpeed() {
  vx = random (vx-0.2f,vx+0.2f);
  vy = random (vx-0.2f,vx+0.2f);
...
class LAser {
  ...
  public void CheckLaserPosition() {
...
class Rectangle {
  ...
  float x, y, w, h;
  int col;
  Rectangle(float xarg, float yarg, float warg, float harg, int carg) {
    noStroke();
    x=xarg;
    y=yarg;
    w=warg;
...
public static class rectangleThickness {
public static int stroke = 3;
  ...
  public static int returnThickness() {
    return stroke-1;
  }
}
  public void settings() {  size(1200, 700);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Breakout_3" };
    if (passedArgs != null) {
